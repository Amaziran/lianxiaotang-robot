...
*           (x) 2025 韩知燃 修改                       *
*               当前版本号:  {}                     *
*    开源：https://github.com/wzpan/wukong-robot.git   *
*          感谢 潘伟洲 wukong-robot 开源               *
*      感谢 王子怡 openai-chatGPT API接口提供          *
********************************************************
...
""".format(
        ...
        self.conversation.say(f"{config.get('first_name', '主人')} 你好！试试对我喊'联小棠'叫醒我吧", True)
    ...
    def _detected_callback(self, is_snowboy):
        def _start_record():
            logger.info("开始录音")
